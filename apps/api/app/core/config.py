...
class Settings(BaseSettings):
    ...
    structure_evidence_file_limit: int = Field(default=8, ge=1, le=50)
    structure_evidence_edge_limit: int = Field(default=12, ge=1, le=100)
    structure_evidence_directory_limit: int = Field(default=8, ge=1, le=50)
    feature_location_file_limit: int = Field(default=8, ge=1, le=25)
    feature_location_neighbor_depth: int = Field(default=2, ge=1, le=3)
    feature_location_test_limit: int = Field(default=5, ge=1, le=20)
