  ...
  score_breakdown: [
    {
      ...
      signal_type: 'unused_candidates',
      count: 2,
      points_deducted: 2,
      explanation: 'Static candidates require review.',
    },
  ],
  unused_code_candidates: [
    {
      ...
      start_line: 3,
      end_line: 8,
      reason: 'No persisted lexical reference.',
      confidence: 0.9,
      recommendation: 'Review dynamic usage.',
      excerpt: 'def orphan(): pass',
      source_url: 'https://github.com/acme/repo/blob/abc/app/a.py#L3-L8',
    },
  ],
  duplicate_code_groups: [
    {
      ...
      members: [
        ...
        },
        {
          ...
          end_line: 9,
          excerpt: 'x',
          source_url: 'https://github.com/acme/repo/blob/abc/app/b.py#L4-L9',
        },
      ],
    },
  ],
  summary: { unused_candidate_count: 1, duplicate_group_count: 1 },
  limitations: ['Dynamic references may be missed.'],
...
test('renders score categories deductions candidates duplicates and exact links', async () => {
  ...
  expect(screen.getAllByRole('link', { name: 'app/a.py:3-8' })[0]).toHaveAttribute(
    'href',
    payload.unused_code_candidates[0].source_url,
  )
